...
/** Record the new changeset versions on the corresponding branch.
 *
 * Return the number of files that actually changed.  This may be zero if the
 * changeset consisted entirely of dead trunk 1.1 revisions corresponding to
 * branch additions.  */
